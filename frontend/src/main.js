...
pluralCaseList.push( {plural: "projects/projects", pascal: "ProjectProject"} )

pluralCaseList.push( {plural: "interests/interests", pascal: "InterestInterest"} )

pluralCaseList.push( {plural: "consultations/consultations", pascal: "ConsultationConsultation"} )

pluralCaseList.push( {plural: "alarms/alarms", pascal: "AlarmAlarm"} )

pluralCaseList.push( {plural: "salesmanmatches/salesmanMatches", pascal: "SalesmanmatchSalesmanMatch"} )
